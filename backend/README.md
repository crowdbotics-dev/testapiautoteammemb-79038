...
## Project Structure
    ...
    ├── testapiautoteammemb_79038  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_79038`
...
2. Clone this repo and `cd testapiautoteammemb_79038`
